...
#Parte del informe de videos procesados mensuales
...
for prueba in range(len(archivo)):
    ...
    for i in range(len(lista_duplic_aco)-1):
        if (lista_duplic_aco[i]+2)!=lista_duplic_aco[i+1]:
            aco_def.append(lista_duplic_aco[i])
    if len(lista_duplic_aco)>0:
        aco_def.append(lista_duplic_aco[-1])
    
    aco_def_def=[]
    for i in range(len(aco_def)-1):
        if (aco_def[i]+3)!=aco_def[i+1]:
            aco_def_def.append(aco_def[i])
    if len(aco_def)>0:
        aco_def_def.append(aco_def[-1])
        
    aco_def_def_def=[]
    for i in range(len(aco_def_def)-1):
        if (aco_def_def[i]+4)!=aco_def_def[i+1]:
            aco_def_def_def.append(aco_def_def[i])
    if len(aco_def_def)>0:
        aco_def_def_def.append(aco_def_def[-1])
        
    aco_def_def_def_def=[]
    for i in range(len(aco_def_def_def)-1):
        if (aco_def_def_def[i]+5)!=aco_def_def_def[i+1]:
            aco_def_def_def_def.append(aco_def_def_def[i])
    if len(aco_def_def_def)>0:
        aco_def_def_def_def.append(aco_def_def_def[-1])
    
    sum_aco=0
    for i in aco_def_def_def_def:
    ...
    for i in range(len(lista_duplic_rai)-1):
        if (lista_duplic_rai[i]+2)!=lista_duplic_rai[i+1]:
            rai_def.append(lista_duplic_rai[i])
    if len(lista_duplic_rai)>0:
        rai_def.append(lista_duplic_rai[-1])
    
    rai_def_def=[]
    for i in range(len(rai_def)-1):
        if (rai_def[i]+3)!=rai_def[i+1]:
            rai_def_def.append(rai_def[i])
    if len(rai_def)>0:
        rai_def_def.append(rai_def[-1])
        
    rai_def_def_def=[]
    for i in range(len(rai_def_def)-1):
        if (rai_def_def[i]+4)!=rai_def_def[i+1]:
            rai_def_def_def.append(rai_def_def[i])
    if len(rai_def_def)>0:
        rai_def_def_def.append(rai_def_def[-1])
        
    rai_def_def_def_def=[]
    for i in range(len(rai_def_def_def)-1):
        if (rai_def_def_def[i]+5)!=rai_def_def_def[i+1]:
            rai_def_def_def_def.append(rai_def_def_def[i])
    if len(rai_def_def_def)>0:
        rai_def_def_def_def.append(rai_def_def_def[-1])
    
    sum_rai=0
    for i in rai_def_def_def_def:
    ...
    for i in range(len(lista_duplic_gr)-1):
        if (lista_duplic_gr[i]+2)!=lista_duplic_gr[i+1]:
            gr_def.append(lista_duplic_gr[i])
    if len(lista_duplic_gr)>0:
        gr_def.append(lista_duplic_gr[-1])
        
    gr_def_def=[]
    for i in range(len(gr_def)-1):
        if (gr_def[i]+3)!=gr_def[i+1]:
            gr_def_def.append(gr_def[i])
    if len(gr_def)>0:
        gr_def_def.append(gr_def[-1])
        
    gr_def_def_def=[]
    for i in range(len(gr_def_def)-1):
        if (gr_def_def[i]+4)!=gr_def_def[i+1]:
            gr_def_def_def.append(gr_def_def[i])
    if len(gr_def_def)>0:
        gr_def_def_def.append(gr_def_def[-1])
        
    gr_def_def_def_def=[]
    for i in range(len(gr_def_def_def)-1):
        if (gr_def_def_def[i]+5)!=gr_def_def_def[i+1]:
            gr_def_def_def_def.append(gr_def_def_def[i])
    if len(gr_def_def_def)>0:
        gr_def_def_def_def.append(gr_def_def_def[-1])
    
    sum_gr=0
    for i in gr_def_def_def_def:
    ...
    #informe_df.to_excel(informe_excel_path, index=False)
